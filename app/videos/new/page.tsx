    ...
    <AdRails>
      <main className="mx-auto flex min-h-[100dvh] max-w-xl flex-col px-1 py-5 pb-28 md:py-7 md:pb-7">
        ...
        <section className="surface-glass mt-5 p-5">
          <h1 className="font-display text-xl font-semibold">Add a video</h1>
          <p className="mt-1 text-sm text-white/55">
            Upload a long-form video (up to 200 MB) or paste a link from YouTube,
            Vimeo, Dailymotion or any other video site.
          </p>
          <div className="mt-4">
            <VideoUpload currentUserId={user.id} />
          </div>
        </section>
      </main>
    </AdRails>
