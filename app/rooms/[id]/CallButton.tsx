  ...
  return (
    <div className="relative">
      <button
        ...
        title="Start a call"
        className="grid h-8 w-8 place-items-center rounded-lg border border-neon-blue/40 bg-neon-blue/10 text-neon-blue transition hover:bg-neon-blue/20"
      >
      ...
      {menuOpen && (
        <div
          className="surface-glass absolute right-0 top-full z-30 mt-2 w-44 p-1.5 shadow-xl"
