        ...
        */}
        ...
        <DismissibleSection id="stories" className="mt-3">
          ...
          <div className="scroll-thin mt-1.5 flex items-stretch gap-2 overflow-x-auto px-1 pb-1">
            ...
            {[
              { href: "/rooms?create=1", icon: "➕", label: "New room" },
              { href: "/rooms#karogroups", icon: "📂", label: "User rooms" },
              ...
              // "New room" (create) and "User rooms" get accents so they're
              // easy to spot in the strip.
              const cls =
                t.label === "New room"
                  ? "border-neon-mint/50 bg-neon-mint/15 text-white hover:bg-neon-mint/25"
                  : t.label === "User rooms"
                  ? "border-neon-purple/50 bg-neon-purple/15 text-white hover:bg-neon-purple/25"
                  : "border-white/10 bg-white/5 text-white/70 hover:bg-white/10 hover:text-white";
              return (
                <Link
                  key={t.href}
                  href={t.href}
                  className={`flex shrink-0 flex-col items-center gap-0.5 rounded-xl border px-3 py-1.5 text-[11px] transition ${cls}`}
                >
