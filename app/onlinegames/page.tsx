...
import { OnlineGamesHub } from "./OnlineGamesHub";

export const dynamic = "force-dynamic";

export const metadata = {
  title: "Online Games · Karochat",
  description: "Free online games from around the world — play classics in your browser or jump to the biggest game portals."
};
