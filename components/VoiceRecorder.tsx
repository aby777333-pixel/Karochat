...
export function VoiceRecorder({
  ...
  return (
    <div
      ...
      className="fixed inset-x-3 bottom-28 z-[60] mx-auto w-auto max-w-[320px] rounded-xl border border-white/10 bg-ink-800/95 p-3 shadow-xl backdrop-blur sm:absolute sm:inset-x-auto sm:bottom-12 sm:left-0 sm:mx-0 sm:w-[280px] sm:max-w-none"
    >
